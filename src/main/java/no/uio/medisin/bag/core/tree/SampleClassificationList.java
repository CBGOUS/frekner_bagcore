...
public class SampleClassificationList {
   ...
   * @param classificatonType
   * @return 
   */
  public ArrayList<String> getAllEntriessForClassificationType(String classificatonType){
    ArrayList<String> matchEntries = new ArrayList<>();
    for (SampleClassification sampleClassification: sampleClassificationList){
      if(sampleClassification.getClassificationType().equals(classificatonType)){
