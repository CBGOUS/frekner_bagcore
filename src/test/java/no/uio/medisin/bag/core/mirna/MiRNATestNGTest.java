...
//      public MiRNA(String cName, String cChrom, int cStart, int cEnd, String cStrand, String cMIMAT, String cParentID, String cSeq)        
    ...
    public static void testIsomiRProcessing(){
        ...
        mirseq.addIsomiR("isomiR2-100",  3580220, "16M", "XA:i:2\t MD:Z:1C9C6\t NM:i:2", "GTGCGCACCGGACGGGCC", 2);
        mirseq.addIsomiR("isomiR3-60",   3580221, "18M", "XA:i:2\t MD:Z:1C9C6\t NM:i:2",  "AGCGCACCGGACGGGCCT", 3);
        mirseq.addIsomiR("isomiR4-25",   3580221, "19M", "XA:i:2\t MD:Z:1C9C6\t NM:i:2", "AAGCGCACCGGACGGGCC", 4);
